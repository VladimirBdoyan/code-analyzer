...
import com.example.codeanalyzerservice.exception.model.ErrorEntity;
import com.example.codeanalyzerservice.exception.model.ValidationError;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorEntity> handleRepositoriesNotFoundException(
            Exception exp) {
        ErrorEntity error =  new ErrorEntity(new Date(),
